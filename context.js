let aboutContext = '<div class="report">' +
                        ...
                        '<div class="pic pic--2" target="">' +
                            '<div class="context">' +
                                ...
                                '<div class="paragraph">' +
                                    ...
                                    'มัธยมปลาย: โรงเรียนสวนกุหลาบวิทยาลัย GPAX 3.95' +
...
let project1Context = '<div class="report">' +
...
let project2Context = '<div class="report">' +
...
function competitionCreate() {
    ...
    competitionContext = '<div class="gallery">' +
...
function activityCreate() {
    ...
    activityContext = '<div class="gallery">' +
                            '<div class="text">Activity</div>' +
                            activityDataText + 
                        '</div>'
}
