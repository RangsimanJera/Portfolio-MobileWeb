class Player extends Sprite {
    ...
    shouldPanCameraToTheLeft({gameCanvas, camera}) {
        ...
        if (cameraboxRightSide >= gameCanvas.width - camera.position.x) {
            ...
            layerBack2_1.velocity.x = 0.25
            layerBack2_2.velocity.x = 0.25
            layerBack2_3.velocity.x = 0.25
            layerBack2_4.velocity.x = 0.25
            layerBack2_5.velocity.x = 0.25
            layerBack2_6.velocity.x = 0.25
            layerBack2_7.velocity.x = 0.25
            layerBack2_8.velocity.x = 0.25
            layerBack2_9.velocity.x = 0.25
            layerBack_1.velocity.x = 0.25
            layerBack_2.velocity.x = 0.25
            layerBack_3.velocity.x = 0.25
            layerBack_4.velocity.x = 0.25
            layerBack_5.velocity.x = 0.25
            layerBack_6.velocity.x = 0.25
            layerBack_7.velocity.x = 0.25
            layerBack_8.velocity.x = 0.25
            layerBack_9.velocity.x = 0.25
            layerBack_10.velocity.x = 0.25
        }
    }
